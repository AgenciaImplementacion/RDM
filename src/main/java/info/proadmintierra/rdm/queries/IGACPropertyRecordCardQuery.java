...
/**
 * IGACPropertyRecordCardQuery
 */
public class IGACPropertyRecordCardQuery {

        public static String getQuery(String schema, String plot_t_id, String parcel_fmi, String parcel_number,
                        String previous_parcel_number, Boolean property_record_card_model) {

                String query = "    WITH" + "     unidad_area_calculada_terreno AS ("
                ...
                query = query.replaceAll("\\{plot_t_id\\}", plot_t_id != null ? plot_t_id : "NULL");
                ...
                query = query.replaceAll("\\{previous_parcel_number\\}",
                                previous_parcel_number != null ? previous_parcel_number : "NULL");
