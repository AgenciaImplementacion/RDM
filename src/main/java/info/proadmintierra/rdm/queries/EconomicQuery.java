 ...
 * EconomicQuery
 */
public class EconomicQuery {

        public static String getQuery(String schema, String plot_t_id, String parcel_fmi, String parcel_number,
                        String previous_parcel_number, Boolean property_record_card_model, Boolean valuation_model) {

                String query = "WITH" + "     unidad_avaluo_predio AS ("
